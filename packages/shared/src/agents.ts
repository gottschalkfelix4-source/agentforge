...
export const AGENT_MANIFESTS: AgentManifest[] = [
  ...
  },
  {
    ...
    providerKinds: ['openai', 'openai_chatgpt', 'openai_compat', 'openrouter', 'ollama'],
    modelFlag: '--model',
  ...
  },
  {
    ...
    baseEnv: {},
    providerKinds: ['anthropic', 'openai', 'openai_chatgpt', 'openrouter', 'openai_compat', 'anthropic_compat', 'ollama', 'gemini'],
    modelFlag: '--model',
